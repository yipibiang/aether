...
class AgentDebugLogTest {
    ...
    @Test
    void parseHelixentDebugLogEnv_returnsNullForNull() {
        assertNull(AgentDebugLog.parseHelixentDebugLogEnv(null));
    }

    @Test
    void parseHelixentDebugLogEnv_returnsNullForBlank() {
        assertNull(AgentDebugLog.parseHelixentDebugLogEnv("   "));
    }

    @Test
    void parseHelixentDebugLogEnv_returnsDefaultForTrue() {
        var result = AgentDebugLog.parseHelixentDebugLogEnv("1");
