 ...
 * <p>
 * Override with environment variable {@code HELIXENT_CONSOLE_CHARSET} (e.g. {@code UTF-8} for
...
public final class ConsoleCharset {
    ...
    public static Charset forConsoleIo() {
        var override = System.getenv("HELIXENT_CONSOLE_CHARSET");
        if (override == null || override.isBlank()) {
            override = System.getProperty("helixent.console.charset");
        }
        if (override != null && !override.isBlank()) {
